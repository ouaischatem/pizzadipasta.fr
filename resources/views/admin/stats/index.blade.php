...
<!-- Permet d'afficher les statistiques de l'application -->
@section('content')
    <div class="container">
        <div class="flex justify-between">
            <h1 class="text-3xl font-medium text-gray-700">Dashboard</h1>
            <a class="hover:cursor-pointer" href="{{ route('home') }}">
                <img alt="Back icon" class="w-10" src="/back-icon.svg">
            </a>
        </div>
        <div class="mt-4">
            <div class="flex flex-wrap -mx-6">
                <div class=" w-full px-6 sm:w-1/2 xl:w-1/3">
                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-xs">
                ...
                <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                    <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                        ...
                        <div class="mx-5">
                            ...
                            <div class="text-gray-500">Postes</div>
                        </div>
                    </div>
                </div>
            </div>
